...
public class RedisZSet {
    ...
    public void addByTypedTuple() {
        DefaultTypedTuple<String> typedTuple = new DefaultTypedTuple<>("E", 2.0);
        DefaultTypedTuple<String> typedTuple1 = new DefaultTypedTuple<>("F", 3.0);
        DefaultTypedTuple<String> typedTuple2 = new DefaultTypedTuple<>("G", 5.0);
    ...
    public void removeRange() {
        Long zset = stringRedisTemplate.opsForZSet().removeRange("zset", 0, 4);
        System.out.println(zset);
    }
}
